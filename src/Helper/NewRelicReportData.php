...
namespace ReadyMage\BetterNewRelic\Helper;
...
class NewRelicReportData
{
    ...
    /**
     * Polyfill for array_key_first method
     *
     * @param array $arr
     * @return int|string|null
     */
    public function arrayKeyFirst(array $arr) {
    ...
    private function extractGqlInfo(ObjectType $gqlFieldsInfo)
    {
        ...
        return [
            ...
            'first_field_name' =>  $this->arrayKeyFirst($gqlFields),
